...
Once I connected my frontend to all the backend I then moved on to finalizing the styling and UI/UX elements, as well as code cleanup wherever needed.
...
Graph QL was both exciting and tricky to learn. The ability to grab only what I need from the query or mutation is certainly enticing, but the amount of setup required to get all the schemas, resolvers, and connections certainly makes it an earned feature.
